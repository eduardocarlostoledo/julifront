...
export const PoliticaPrivacidad = () => {
  const sections = [
    ...
    },
    {
      ...
      content: (
        <p>
          July Marroquinería ofrece productos de moda a través de su tienda online. Nos reservamos el derecho de modificar, actualizar o discontinuar productos sin previo aviso.
        </p>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <p>
          Es responsabilidad del usuario mantener segura su cuenta y sus credenciales. July Marroquinería no se hace responsable por accesos no autorizados si se deben a negligencia del usuario.
        </p>
      ),
    },
    {
      ...
      content: (
        <ul>
          ...
          <li>July Marroquinería se reserva el derecho de rechazar o cancelar pedidos por motivos de stock, validación de identidad o sospechas de fraude.</li>
        </ul>
      ),
    },
    {
    ...
    },
    {
      ...
      content: (
        <p>
          Todo el contenido del sitio (textos, imágenes, diseño, logos) es propiedad de July Marroquinería o sus proveedores. No está permitido copiar, distribuir o modificar sin autorización expresa.
        </p>
      ),
    },
    {
